...
void Sandbox::OnAttach()
{
	...
	m_Player = std::make_shared<Player>("res/animation/test.fbx", "res/textures/Dot/man.png");
	...
	m_Grass = std::make_shared<Dot::BrushInstance>("res/models/Dot/grass.obj", "Grass",300);
