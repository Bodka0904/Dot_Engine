...
void GuiShader::UpdateTexOffset(glm::vec2 texOffset)
{
	glUniform2fv(m_uniforms[TEX_OFFSET_U], 1, &texOffset[0]);
}
...
unsigned int GuiShader::CreateShader(const std::string & text, unsigned int shaderType)
{
